...
#pragma region "object_initialization"
	...
	GLuint floorTexture = loadTexture("sucai/wall.jpg");
	GLuint transparentTexture = loadTexture("sucai/grass.png", true);
	GLuint wallTexture = loadTexture("sucai/wall3.jpg");
#pragma endregion
	//入口
	...
	faces.push_back("sucai/ame_nebula/purplenebula_rt.jpg");
	faces.push_back("sucai/ame_nebula/purplenebula_lf.jpg");
	faces.push_back("sucai/ame_nebula/purplenebula_up.jpg");
	faces.push_back("sucai/ame_nebula/purplenebula_dn.jpg");
	faces.push_back("sucai/ame_nebula/purplenebula_bk.jpg");
	faces.push_back("sucai/ame_nebula/purplenebula_ft.jpg");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform1f(lightSpotCutOffLoc, glm::cos(glm::radians(5.0f)));
